...
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar() ?>'>Historiaberita.</a></div>
            <div class="menu">
                <ul>
                    <li><a href="<?php echo url_dasar() ?>#home">Home</a></li>
                    <li><a href="<?php echo url_dasar() ?>#aboutus">AboutUs</a></li>
                    <li><a href="<?php echo url_dasar() ?>#article">Article</a></li>
                    <li><a href="<?php echo url_dasar() ?>#gallery">Gallery</a></li>
